...
{
    Tree lbl;
    faustassert(isBoxTap(a, lbl));
    return makeBlockSchema(0, 1, tree2quotedstr(lbl), slotcolor, "");
}
...
static schema* generateTapDefSchema(Tree a)
{
    ...
    faustassert(isBoxTap(tap, lbl));
    return makeBlockSchema(1, 0, tree2quotedstr(lbl), slotcolor, "");
}
